...
{   
    public class nowWereTalking : MonoBehaviour
    {
       ...
       [SerializeField]
        ...
        //    Boolean to use Adventure Creator;
        [SerializeField]
        [Tooltip("Set this checkbox to TRUE (by ticking it) if you wish to use Adventure Creator audio (or a different AudioSource i.e. not NWT) to drive an NWT mouth.  Also NOTE audio files need to be set to 'Decompress on load'.")]
        bool useAdventureCreatorBool;  // checked = yes unchecked = no
